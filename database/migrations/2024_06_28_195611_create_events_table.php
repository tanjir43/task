...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('events', function (Blueprint $table) {
            ...
            $table->enum('for_whom', ['male', 'female', 'other','all'])->nullable()->default('all'); #specify separetly
            ...
            $table->boolean('is_specific')->nullable()->default(false); #if true then only specific by event will be area wise 
