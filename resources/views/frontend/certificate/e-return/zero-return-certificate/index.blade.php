...
<aside role="complementary">
    <div class="csh-aside">
        ...
        <ul role="list">
            <li role="listitem"><a
                    href="{{route('tin.certificate')}}" target="_blank"
                    role="link" class="csh-aside-spaced csh-text-wrap csh-font-sans-regular">TIN Certificate</a></li>
            <li role="listitem"><a href="https://ticket.etaxnbr.gov.bd/" target="_blank"
                    role="link" class="csh-aside-spaced csh-text-wrap csh-font-sans-regular">e-Return Help Desk</a></li>
            <li role="listitem"><a href="{{route('manual.e.return.certificate')}}" target="_blank"
                    role="link" class="csh-aside-spaced csh-text-wrap csh-font-sans-regular">e-Return Manual Registration</a></li>
        </ul>
    </div>
</aside>
                ...
                <div class="csh-article-content-header-metas">
                    <div class="csh-article-content-header-metas-category csh-font-sans-regular">
                        Articles on:<span> </span><a
                            ...
                            role="link">e Return</a></div>
                </div>
                <h1 class="csh-font-sans-bold">Zero Return Certificate (e Return)</h1>
            </div>
            <div role="article" class="csh-article-content-text csh-article-content-text-large"> At the very first Create an account with your TIN and your <span
                class="csh-markdown csh-markdown-italic">NID Verified Phone Number.</span> 

                <br
                    class="csh-new-line" /><br class="csh-new-line" />
                ...
                <br
                    class="csh-new-line" />
                    <a href="https://etaxnbr.gov.bd/#/auth/sign-up" target="_blank">Registration Link</a>
                    <br class="csh-new-line" />
                    <br class="csh-new-line" />

                    For more  guideline you can follow the Official User Manual. Please Download it <a href="{{asset('frontend/e-return/e-Return_user_manual.pdf')}}" download="" target="_blank">e Return User Manual</a>

                    <br class="csh-new-line" />
                    <br class="csh-new-line" />

                    <span style="color: rebeccapurple">If complete  the  Registration Process, Please Download the  e Return Certificate.</span> <br class="csh-new-line" />
                            

                    <br class="csh-new-line" />
                    <span data-type="||" class="csh-markdown csh-markdown-emphasis csh-font-sans-medium">Facing any Trouble to register? Please Contact <a href="https://ticket.etaxnbr.gov.bd/" target="_blank"> e Return help desk</a></span>

                    
                    <br
                      class="csh-new-line"
                    /><br class="csh-new-line" />Help Desk Procedure:<br
                      class="csh-new-line"
                    /><br class="csh-new-line" /><span
                      data-type="*"
                      class="csh-markdown csh-markdown-list"
                      >Create a  Ticket for what type  of issue  you are  facing <a href="https://ticket.etaxnbr.gov.bd/open.php" target="_blank"> Create a  Ticket</a></span
                    ><br class="csh-new-line" /><span
                      data-type="*"
                      class="csh-markdown csh-markdown-list"
                      >Check Ticket Status <a href="https://ticket.etaxnbr.gov.bd/view.php" target="_blank">Ticket Status</a></span
                    ><br class="csh-new-line" />

                    <br class="csh-new-line" />
                    <span data-type="||" class="csh-markdown csh-markdown-emphasis csh-font-sans-medium">Didn't get response from help-desk? Try it manually! <a href="{{route('manual.e.return.certificate')}}" target="_blank"> Read more</a></span>
