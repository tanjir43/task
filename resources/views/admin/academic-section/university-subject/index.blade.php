...
@section('content')
    <div class="row">
        <div class="col-sm-12 col-md-8">
            <x-card variant="primary" outline="true" title="{!! __('msg.subject').' '.__('msg.list') !!}">
                <x-slot name="body">
                    <div class="table-responsive">
                        <table class="table table-bordered" id="university_subject_table" style="width: 100%">
                            <thead>
                                <tr>
        ...
        <div class="col-sm-12 col-md-4">
            <x-form route="academic-subject.store" :update="$record->id ?? null">
                <x-slot name="body">
                    <x-card variant="primary"  title="{{__('msg.subject').' '.__('msg.information')}}">
                        <x-slot name="body">
                            ...
                            <div class="form-group pt-3">
                                ...
                                {!! Form::text('code',$record->code ?? old('code'),$attr) !!}
                            </div>
                            <x-slot name="footer">
...
<script>
    $(function() {
        ...
        window.LaravelDataTables["dataTableBuilder"]=$("#university_subject_table").DataTable({
            "serverSide":true,
            "processing":true,
            "ajax":{
                "url" : '{{route('academic-subject.datatable')}}',
                "type": "GET"
            },
            "columns":[
